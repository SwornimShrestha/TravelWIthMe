    ...
    <div className=" min-h-screen flex flex-col lg:flex-row items-center md:mx-32 mx-5 gap-14">
      <div className=" w-full lg:w-2/4">
        <div className=" space-y-4">
          ...
          <p>
            Discover the Best Holiday Experiences with TripWithMe! We're
        ...
        <div className="w-full lg:w-3/5 mt-10 lg:ml-14">
          <img
            ...
            src="https://plus.unsplash.com/premium_photo-1661907101203-ad65f1905049?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="img"
          />
        </div>
      </div>
